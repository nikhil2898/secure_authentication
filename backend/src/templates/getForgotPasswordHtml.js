export const getForgotPasswordHtml = ({ email, token }) => {
  const appName = process.env.APP_NAME || "Secure Authentication App";
  const baseUrl = process.env.FRONTEND_URL || "http://localhost:5173";

  const verifyUrl = `${baseUrl.replace(/\/+$/, "")}/reset/${encodeURIComponent(token)}`;
          ...
          <table class="container">
            ...
            <tr>
              <td class="p-32">
                ...
                <p class="text">
                  Thanks for registering with ${appName}. Click the button below to reset your password.
                </p>
